	...
	<body>
		<div id="contenedor">
			...
			<section>
				...
				<article style="height:70em; width:940px;">

					<h2>Informaci&oacute;n tur&iacute;stica de Cochabamba producida por la Carrera de Turismo</h2>
					<div id="opciones">
						<ul>
							<li><a href="catalogs/catalogo.php">Clasificaci&oacute;n de atractivos, administrador</a></li>
							<li><a href="ubicacion3.php">Divisi&oacute;n pol&iacute;tica</a></li>
							<li><a href="navegar_por_el_catalogs/catalogo.php">Clasificaci&oacute;n</a></li>
							...
						</ul>
					</div>
					<div id="mapita">
