	...
	<body onload="inicio()">
		<div id="contenedor">
			...
			<section>
				...
				<div id="opciones">
						<div class="menu12">
							<div class="la_opcion"><h3><a href="mapas_pocona.php">Mapa de servicios turísticos</a></h3></div>
							<div class="la_imagen"><img src="fotos/imagen_mapa.JPG" width="82" height="82" border="0"></div>
						</div>
						<div class="menu12">
							<div class="la_opcion"><h3><a href="mapas_pocona.php">Rutas o vías de acceso</a></h3></div>
							<div class="la_imagen"><img src="fotos/imagen_mapa1022.JPG" width="82" height="82" border="0"></div>
						</div>
						<div class="menu12">
							<div class="la_opcion"><h3><a href="mapas_pocona.php">Límites</a></h3></div>
							<div class="la_imagen"><img src="fotos/imagen_mapa.JPG" width="82" height="82" border="0"></div>
						</div>
						<div class="menu12">
							<div class="la_opcion"><h3><a href="mapas_pocona.php">Situación astronómica</a></h3></div>
							<div class="la_imagen"><img src="fotos/imagen_mapa1022.JPG" width="82" height="82" border="0"></div>
						</div>
						<div class="menu12">
							<div class="la_opcion"><h3><a href="mapas_pocona.php">Unidad fisiográfica</a></h3></div>
							<div class="la_imagen"><img src="fotos/imagen_mapa.JPG" width="82" height="82" border="0"></div>
						</div>
						<div class="menu12">
